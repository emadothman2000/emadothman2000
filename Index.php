...
if (!$conn) {
  ...
  while ($x <= $end) {
    ...
    $sqlInsert = "INSERT INTO result (SeatNo,Name,School,Edarah,Status,Shoba,AR,E,Lang2,M1,H,G,Ph,Spirit,Ch,Pi,Geo,M2,Phis,Total,Pre,Re,Country,Eco) VALUES ('$x','$name','$school','$edarah','$status','$shoba','$ar','$e','$lang2','$M1','$H','$G','$ph','$spirit','$ch','$Pi','$Geo','$M2','$phis','$total','$PreF','$Re','$Country',$Eco)";
